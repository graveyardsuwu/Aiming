return function(Type, PatchName)
    ...
    -- // Vars
    local PatchFormat = "https://raw.githubusercontent.com/graveyardsuwu/Aiming/main/GamePatches"
    ...
    if (not Success) then
        local ModuleFormat = "https://raw.githubusercontent.com/graveyardsuwu/Aiming/main/Module"
